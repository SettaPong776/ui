...
function App() {
  return (
    <>
      <div className="flex flex-col justify-center mx-auto p-2 bg-white" style={{ width: "100%" }}>
        ...
        <div className="border-2 flex flex-col rounded-xl min-h-screen">
          <div className="rounded-lg  flex ">
            <div className=" font-bold text-white flex  w-[90%] h-[300px] text-start  border border-black  border-b-none rounded-t-lg rounded-r-none">
              <div className="w-[50%]">
                <div className="bg-[#2f2a2b] p-3">
            ...
            <div className="w-[10%] flex flex-col justify-between border-b">
              <div className="bg-[#2f2a2b] p-3 text-center text-white">
                คะแนน
              </div>
              <div className=" text-center h-auto p-2  border-black">
                ____ /5
              </div>
            </div>
          </div>
          ...
          <div className="flex w-full  border-t-2">
            <div className=" font-bold text-white flex  w-[90%] h-[300px]  text-start  border-b-none  rounded-r-none">
              <div className="flex flex-col justify-between p-2 w-[90%]  text-black">
          ...
          <div className="flex w-full border-t">
            <div className="font-bold text-white flex w-[90%] h-[300px] text-start border-b-none rounded-r-none">
              ...
              <div className="w-[80%] flex justify-between py-5 px-5 text-black">
                <div className="flex flex-col justify-between py-20 px-2 w-[90%] h-10 text-black">
          ...
          <div className="flex w-full border-t">
            <div className=" font-bold text-white flex  w-[90%]  text-start  border border-black  border-b-none rounded-r-none">
              <div className="w-[25%] max-h-[200px]">
                ...
                <div className="bg-black p-2  flex">Optional
